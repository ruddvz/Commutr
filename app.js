(function () {
  var screenIds = ['ob', 'signup', 'home', 'search', 'post', 'detail', 'chat', 'inbox', 'profile', 'dashboard', 'notifs', 'history', 'settings', 'sos', 'sub'];
  var obIndex = 0;
  var obCount = 3;
  var toastTimer = null;
  ...
  function sendMsg() {
    ...
    wrapper.innerHTML = '<div class="bout"><div class="btxt">' + escapeHtml(value) + '</div><div class="bmeta">' + hours + ':' + minutes + ' ' + meridiem + ' \u2713\u2713</div></div>';
